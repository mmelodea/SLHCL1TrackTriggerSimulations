...
options.nevents = 500           # analyze first nevents
...
def init():
    ...
    gROOT.LoadMacro(
    "/uscms_data/d2/jiafu/L1TrackTrigger/CMSSW_6_2_0_SLHC25_patch3/src/SLHCL1TrackTriggerSimulations/AMSimulationIO/src/AMSimulationIOLinkDef.h")
